...
"""Test script to understand TT SmoothEmbedding's."""
...
if __name__ == "__main__":
    x = torch.randint(0, 100, size=(5, 10))

    ## test with weights
    embed = SmoothEmbedding(
        100, 32, weights=[0.15, 0.2, 0.3, 0.2, 0.15], stop_token=True
    )
    out = embed(x)
